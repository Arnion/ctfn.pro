...
$this->title = Yii::t('Title', 'Resend Verification Email'); 
						...
						<div class="title-heading text-center my-auto">
							<div class="form-signin px-4 py-5 bg-white rounded-md shadow-sm">
								...
								<?php $form = ActiveForm::begin(['id' => 'resend-form']); ?>
									...
									<h5 class="mb-4"><?=Yii::t('Title', 'Resend Verification Email')?></h5>
									
									<p class="text-muted"><?=Yii::t('Frontend', 'Help resend password')?></p>

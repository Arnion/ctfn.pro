			...
			<div class="row align-items-center">
				...
				<div class="col-sm-6 mt-4 mt-sm-0 pt-2 pt-sm-0">	  
					 <ul class="list-unstyled social-icon foot-social-icon mb-0 mt-4" style="text-align:right">
						<li class="list-inline-item lh-1"><a href="/<?=str_replace('/default', '', Yii::$app->controller->route)?>?lang=en" class="rounded"><img src="/images/flags/en-EN.png"></a></li>
						<li class="list-inline-item lh-1"><a href="/<?=str_replace('/default', '', Yii::$app->controller->route)?>?lang=ru" class="rounded"><img src="/images/flags/ru-RU.png"></a></li>

	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer visually-hidden">
				<button type="button" class="btn btn-secondary close" data-dismiss="modal"><?=Yii::t('Frontend', 'Close')?></button>
...
<header id="topnav" class="defaultscroll sticky">
	<div class="container">
		<!-- Logo Start-->
		<a class="logo" href="/">
			<img src="/images/logo/logo-dark.png" height="26" class="logo-light-mode" alt="">
			<img src="/images/logo/logo-white.png" height="26" class="logo-dark-mode" alt="">
		</a>
		<!-- Logo end-->
